...
<html>
    ...
    <div id="content" role="main">
        <div class="container">
            ...
            <section class="row">
                <div id="show-attachment" class="col-12 scaffold scaffold-show" role="main">
                    <h1><g:message code="default.show.label" args="[entityName]" /></h1>
                    <g:if test="${flash.message}">
                    <div class="alert alert-success" role="status">${flash.message}</div>
                    </g:if>
                    <f:display bean="attachment" />
                    <g:form resource="${this.attachment}" method="DELETE">
                        <fieldset class="buttons offset-3">
                            <g:link class="btn btn-primary" action="edit" resource="${this.attachment}">
